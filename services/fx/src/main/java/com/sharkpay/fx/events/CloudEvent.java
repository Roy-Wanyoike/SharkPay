...
/**
 * CloudEvents 1.0 envelope as published by this service, matching
 * contracts/events/fx.v1.json exactly (required fields, no extras):
 * {@code id, type, specversion, source, subject, occurred_at, data}.
 *
 * <p>Consumers dedupe on {@code id} (UUID); {@code type} equals the Kafka
 * topic name; {@code source} is the producing service
 * ({@value #SOURCE}); {@code subject} is the affected quote or conversion
 * id.
 */
public record CloudEvent(String id, String type, String specversion, String source, String subject,
    ...
    public static final String SOURCE = "sharkpay/fx";
