 ...
 * contracts/events/recon.v1.json schema exactly (required fields, no
 * extras): {@code id, type, specversion, source, subject, occurred_at,
 * data}.
 *
 * <p>Consumers dedupe on {@code id} (UUID v7); {@code type} equals the
 * Kafka topic name; {@code source} is the producing service
 * ({@value #SOURCE}); {@code subject} is the affected run, break or
 * compensation id.</p>
 */
public record CloudEvent(String id, String type, String specversion, String source, String subject,
    ...
    public static final String SOURCE = "sharkpay/reconciliation";
